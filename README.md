...
As informações foram baseadas nos dados fornecidos diretamente pelo titular e nos arquivos enviados como fonte:

- `Portfólio Profissional.pdf`
- `Dissertação Lucas Ribeiro Vfinal.pdf`
- `Metodologia e Resultados atualizado.pdf`

Nenhuma experiência, cargo, publicação, DOI, link de repositório específico ou informação não fornecida foi inventada.
